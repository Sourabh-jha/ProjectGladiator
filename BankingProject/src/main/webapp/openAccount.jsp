...
<body>
	...
	<option value="West Bengal" name="state">West Bengal</option>
				...
				<tr>
					<td><b><u>Permanent Address:</u></b></td>
				</tr>
				
				<tr>
					<td>
					<input type="checkbox" name="PermanentaddressSame" value="addressSame"> &nbsp <b>Permanent Address Same as Mailing Address</b>
					</td>
				</tr>
...
-->
				...
				<tr>
					<td><input type="checkbox" name="UsernetBanking"
						value="optForNetBanking"> &nbsp <b>Opt For Net Banking
					</b></td>
				</tr>
				<tr>
